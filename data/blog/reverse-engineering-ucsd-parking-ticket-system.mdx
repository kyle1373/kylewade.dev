...
draft: false
summary: "Parking tickets are a notorious issue for students and faculty at the University of California, San Diego (UCSD). In this article, I detail how I reverse engineered UCSD's parking ticket system, which led to the creation of a website that tracked the real time locations of parking tickets being issued across campus."
images: ['/blog/reverse-engineering-ucsd/ucsdtickets_ver2.png']
---

## Overview

Recently, I reverse engineered UCSD's parking ticket system, which led to the creation of a website that tracked the real time locations of parking tickets being issued across campus. Despite it eventually being shut down by the university, the project demonstrated a vulnerability in a widespread ticketing system used by hundreds of universities today.
